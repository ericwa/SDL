...
SDL_DYNAPI_PROC(Uint32,SDL_GetMouseStateFloat,(float *a, float *b),(a,b),return)
SDL_DYNAPI_PROC(Uint32,SDL_GetRelativeMouseState,(int *a, int *b),(a,b),return)
SDL_DYNAPI_PROC(Uint32,SDL_GetRelativeMouseStateFloat,(float *a, float *b),(a,b),return)
